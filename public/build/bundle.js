...
var app = (function () {
  ...
  class LayerManager {
    ...
    observeLayerSequence() {
      this.layerObserver = new MutationObserver(
        this.getLayerSequence.bind(this)
      );
    ...
    getLayerSequence() {
      ...
      this.layerSequence = layers.map(
        (layer) => +(layer.dataset.layerId ?? -1)
      );
      this.redraw();
    }
    startRenderLoop() {
    ...
    const block = {
      c: function create() {
        ...
        attr_dev(
          canvas_1,
          "width",
          (canvas_1_width_value = /*width*/ ctx[0] * /*_pixelRatio*/ ctx[5])
        );
        attr_dev(
          canvas_1,
          "height",
          (canvas_1_height_value = /*height*/ ctx[1] * /*_pixelRatio*/ ctx[5])
        );
          ...
          dispose = [
            ...
            listen_dev(
              ...
              function () {
                if (
                  is_function(
                    /*layerEvents*/ ctx[3] ? /*handleLayerEvent*/ ctx[10] : null
                  )
                )
                  /*layerEvents*/ (ctx[3]
            ...
            listen_dev(
              canvas_1,
              "fullscreenchange",
              /*fullscreenchange_handler*/ ctx[21],
              false,
              false,
              false
            ),
            listen_dev(
              canvas_1,
              "fullscreenerror",
              /*fullscreenerror_handler*/ ctx[22],
              false,
              false,
              false
            ),
            ...
            listen_dev(
              canvas_1,
              "gotpointercapture",
              /*gotpointercapture_handler*/ ctx[62],
              false,
              false,
              false
            ),
            listen_dev(
              canvas_1,
              "lostpointercapture",
              /*lostpointercapture_handler*/ ctx[63],
              false,
              false,
              false
            ),
      ...
      p: function update(new_ctx, dirty) {
        ...
        if (
          !current ||
          (dirty[0] & /*width, _pixelRatio*/ 33 &&
            canvas_1_width_value !==
              (canvas_1_width_value =
                /*width*/ ctx[0] * /*_pixelRatio*/ ctx[5]))
        ) {
        ...
        if (
          !current ||
          (dirty[0] & /*height, _pixelRatio*/ 34 &&
            canvas_1_height_value !==
              (canvas_1_height_value =
                /*height*/ ctx[1] * /*_pixelRatio*/ ctx[5]))
        ) {
        ...
        if (
          dirty[0] & /*width*/ 1 &&
          style_width !== (style_width = `${/*width*/ ctx[0]}px`)
        ) {
          set_style(canvas_1, "width", style_width);
        }
        ...
        if (
          dirty[0] & /*height*/ 2 &&
          style_height !== (style_height = `${/*height*/ ctx[1]}px`)
        ) {
          set_style(canvas_1, "height", style_height);
        }
  ...
  function instance$4($$self, $$props, $$invalidate) {
    ...
    $$self.$$set = ($$props) => {
      ...
      if ("pixelRatio" in $$props)
        $$invalidate(11, (pixelRatio = $$props.pixelRatio));
      if ("style" in $$props) $$invalidate(2, (style = $$props.style));
      if ("autoclear" in $$props)
        $$invalidate(12, (autoclear = $$props.autoclear));
      if ("layerEvents" in $$props)
        $$invalidate(3, (layerEvents = $$props.layerEvents));
    ...
    $$self.$inject_state = ($$props) => {
      ...
      if ("_pixelRatio" in $$props)
        $$invalidate(5, (_pixelRatio = $$props._pixelRatio));
    };
    ...
    $$self.$$.update = () => {
      ...
      if (
        $$self.$$.dirty[0] &
        /*width, height, pixelRatio, autoclear, manager*/ 71683
      ) {
        manager.resize();
      }
    };
  ...
  class Canvas extends SvelteComponentDev {
    ...
    get width() {
      throw new Error(
        "<Canvas>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      );
    }

    set width(value) {
      throw new Error(
        "<Canvas>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      );
    }
  ...
  class Layer extends SvelteComponentDev {
    ...
    get setup() {
      throw new Error(
        "<Layer>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      );
    }

    set setup(value) {
      throw new Error(
        "<Layer>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      );
    }
  ...
  function instance$1($$self, $$props, $$invalidate) {
    ...
    $$self.$$.on_mount.push(function () {
      ...
      if (
        file === undefined &&
        !("file" in $$props || $$self.$$.bound[$$self.$$.props["file"]])
      ) {
      ...
      if (
        rank === undefined &&
        !("rank" in $$props || $$self.$$.bound[$$self.$$.props["rank"]])
      ) {
      ...
      if ($$self.$$.dirty & /*image, file, rank*/ 28) {
        $$invalidate(
          ...
          (render = ({ context }) =>
            context.drawImage(
              image,
              file * chess.squareSize,
              rank * chess.squareSize,
              chess.squareSize,
              chess.squareSize
            ))
        );
